...
//Shaders
const char* vertexLightingShaderSource = "/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/shaders/light_cube.vs";
const char* fragmentLightingShaderSource = "/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/shaders/light_cube.fs";

const char* vertexCubeShaderSource = "/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/shaders/colors.vs";
const char* fragmentCubeShaderSource = "/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/shaders/colors.fs";
...
//	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 11 * sizeof(float), (void*)(8 * sizeof(float)));
	...
	//Loading Image
	unsigned int diffuseMap = loadTexture("/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/images/container2.png");
	unsigned int specularMap = loadTexture("/home/Anthony/Coding/cpp/OpenGlPractice/LightingMapsPractice/images/container2_specular.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		Shapes::makeCube(cubeShader, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.5f, 0.25f), glm::vec3(1.0f), 0.0f);
